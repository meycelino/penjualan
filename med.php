...
<div class="w3-row w3-blue-grey w3-padding">
  <div class="w3-half" style="margin:15px 0 2px 0;"><b class='w3-text-shadow w3-text-bold w3-opacity'>CV. GUNUNGMEDIA COMPUTER</b><br><i style="font-size:12px;">Jl Beliang Toko GUNUNGMEDIA COMPUTER (Samping Jalan Bukit Raya X) - Palangka Raya</i></div>
  ...
  <!--onmouseout="w3_hide_scroll()" onmouseover="w3_show_scroll()"-->
    ...
    <div style="margin-left:250px;">
        ...
        <ul class="w3-navbar w3-light-grey w3-small w3-card-4">
          ...
          <li><a class="w3-hover-black w3-padding-10" href="med.php?mod=penjualan"><i class="fa fa-shopping-cart"></i> Transaksi Servis</a></li>
