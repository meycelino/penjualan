...
<div class="w3-top">
  ...
  <div class="w3-row w3-blue-grey w3-padding">
    <div class="w3-half" style="margin:15px 0 2px 0;"><b class='w3-text-shadow w3-text-bold w3-opacity'>CV. GUNUNGMEDIA COMPUTER</b><br><i style="font-size:12px;">Jalan Beliang Toko GUNUNGMEDIA COMPUTER (Samping Jalan Bukit Raya X) - Kota Palangka Raya</i></div>
