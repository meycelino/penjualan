				...
				if($fd_kul > 0)
				{
					...
					while ($m = mysql_fetch_assoc($sql_kul)) {
						echo"<tr>
							...
							<td><a href='$aksi?mod=pembelian&act=hapus&id=$m[no_faktur]' onclick=\"return confirm('Pastikan anda sudah mereturn barang. Yakin hapus data?');\"><i class='fa fa-trash w3-large w3-text-red'></i></a>
							</td>
				...
				<div class='w3-col s9'>
					...
					<div class='w3-row-padding'>
						...
						<div class='w3-col s5'>
							...
							$no_transaksi = no_pembelian_auto();
							echo "
