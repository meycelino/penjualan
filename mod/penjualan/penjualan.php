						...
						if(mysql_num_rows($sql_tmp) > 0)
						{
							while ($b = mysql_fetch_assoc($sql_tmp)) {
								...
								echo"<tr style='border-bottom:1px dashed #ccc;'>
									...
									<td><a href='$aksi?mod=penjualan&act=batal&id=$b[kode_barang]&jmlqty=$jmlqty' onclick=\"return confirm('Yakin ingin membatalkan?');\"><i class='fa fa-close w3-tiny w3-text-grey'></i></a></td>
								</tr>";
